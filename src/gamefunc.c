...
void newammo(char player, char type)
{
    ...
    switch (type)
    {
        ...
        case W_BIGSLING:
        case W_BLASTGUN:
            ammo[nextammo].xi = cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 4 + plr[player].xi;
            ammo[nextammo].yi = sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 4 + plr[player].yi;
        ...
        case W_PLASMA:
            ammo[nextammo].xi = cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 35 / 10 + plr[player].xi;
            ammo[nextammo].yi = sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 35 / 10 + plr[player].yi;
        ...
        case W_CRAWLER:
            ...
            ammo[nextammo].y = plr[player].y + ((SHIPH / 2) << FIXP) -
                sint[((plr[player].dir >> FIXP) * FRFIX + SCT * 3 / 4) % SCT] * 10 - FIXS;
            ammo[nextammo].xi = -cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                         * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 3 + plr[player].xi;
            ammo[nextammo].yi = -sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                         * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 3 + plr[player].yi;
            ammo[nextammo].damage = 9 << FIXP;
        ...
        case W_BOMB:
            ...
            ammo[nextammo].xi = -cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                         * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] + plr[player].xi / 2;
            ammo[nextammo].yi = -sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                         * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] + plr[player].yi / 2;
        ...
        case W_PULSLASER:
            ammo[nextammo].xi = cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 5 + plr[player].xi;
            ammo[nextammo].yi = sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                        * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 5 + plr[player].yi;
            ammo[nextammo].damage = 3 << FIXP;
            ammo[nextammo].timeleft = 9999;
            break;
        case W_ULTRATHR:
	...
	break;
        case W_TRACTBEAM:
            /*r */ ammo[nextammo].xi = cost[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
                                               * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 4 + plr[player].xi;
	ammo[nextammo].yi = sint[((((plr[player].dir + rand() % (FIXS / 2) - FIXS / 4)
				    * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 4 + plr[player].yi;
	ammo[nextammo].damage = FIXS / 2;
	...
	ammo[nextammo].xi = cost[((((plr[player].dir + FIXS + rand() % (FIXS / 2) - FIXS / 4)
				    * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 5 + plr[player].xi;
	ammo[nextammo].yi = sint[((((plr[player].dir + FIXS + rand() % (FIXS / 2) - FIXS / 4)
				    * FRFIX) >> FIXP) + SCT * 3 / 4) % SCT] * 5 + plr[player].yi;
	ammo[nextammo].damage = 3 << FIXP;
	ammo[nextammo].timeleft = 9999;
	nextammo = (nextammo + 1) % MAXAMMO;
