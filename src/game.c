	     ...
	     */
             ...
             */
                    ...
                    if (((plr[p].bot && IS_SET(ACTION_FIRE_SPECIAL, plr[p].action)) ||
                         (!plr[p].bot && (key(plr[p].k_fire2) || waskey(plr[p].k_fire2)))) &&
                        (plr[p].firepause == 0) && (plr[p].ammo2 != W_NOWEAPON)) {
                        ...
                        plr[p].xi -= (int)(cost[((plr[p].dir >> FIXP) * FRFIX + SCT * 3 / 4) % SCT] * weapons[plr[p].ammo2].recoil);
                        plr[p].yi -= (int)(sint[((plr[p].dir >> FIXP) * FRFIX + SCT * 3 / 4) % SCT] * weapons[plr[p].ammo2].recoil);
             ...
             */
                     ...
                     * weapon change
                     */
                            if (((!key(plr[p].k_left)) && !plr[p].bot && (waskey(plr[p].k_left))) && (plr[p].slotchangepause == 0)) {
                            ...
                            if (((!key(plr[p].k_right)) && !plr[p].bot && (waskey(plr[p].k_right))) && (plr[p].slotchangepause == 0)) {
                                sound_eff(S_TUHNU, 32, pan, 8192, 0);
                            ...
                            if (((!key(plr[p].k_right)) && !plr[p].bot && (!key(plr[p].k_left))) && ((!waskey(plr[p].k_right)) && (!waskey(plr[p].k_left)))) {
            ...
            for (p = 0; p < MAXAMMO; p++) {
                 ...
                 */
                    for (a = 0; a < (MAXPLAYERS + MAXBOTS); a++) {
                        if ((plr[a].active) && (plr[a].energy > 0)) {
                            ...
                            if ((ox < ammo[p].hitdist * 2) && (oy < ammo[p].hitdist * 2)) {
                 ...
                 */
                    ...
                    if ((ammo[p].oyp >= 0 &&
                        ...
                        (ammo[p].xp < 0) || (ammo[p].yp < 0) || (ammo[p].xp >= levw) || (ammo[p].yp >= levh)) {
            ...
            for (p = 0; p < MAXCRAP; p++) {
                 ...
                 */
                    ...
                    case 3:
                        ...
                        if ((crap[p].xp < 0) || (crap[p].yp < 0) ||
                            (crap[p].xp >= levw) || (crap[p].yp >= levh) ||
                            (*(mask + (crap[p].yp) * levw + crap[p].xp) == 0) || (*(mask + (crap[p].yp) * levw + crap[p].xp) == 255)) {
                            crap[p].active = 0;
                        }
                        break;
                    }
                    ...
                    if (boom[p].transp == 0) {
                        for (a = 0; a < (MAXPLAYERS + MAXBOTS); a++) {
                            if ((plr[a].active) && (plr[a].energy > 0)) {
                                ...
                                if ((ox < boomanim[boom[p].type].w) && (oy < boomanim[boom[p].type].h)) {
