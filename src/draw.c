    ...
    for (p = 0; p < MAXPLAYERS; p++) {
        if (plr[p].active) {
                ...
                if (crap[a].active) {
                    ...
                    case 4:
                        ...
                        if ((x > 0) && (y > 0) && (x < WINW - 1) && (y < WINH - 1)) {
                            ...
                            if ((*(plr[p].scr + o) > 0) && (*(plr[p].scr + o) < 8)) {
            ...
            for (a = 0; a < MAXAMMO; a++) {
                if (ammo[a].active) {
                    ...
                    case W_PULSLASER:
                        ...
                        if (((x >= 0) && (y >= 0) && (x < WINW) && (y < WINH)) || ((ox >= 0) && (oy >= 0) && (ox < WINW) && (oy < WINH))) {
            ...
            if (basedetect(plr[p].xp, plr[p].yp) &&
                ...
                b = (sint[(cnt * 15) % (SCT / 2) + SCT / 2] >> (FIXP - 5)) + 56;
            ...
            if ((basedetect(plr[p].xp, plr[p].yp) == 1) && (plr[p].energy > 0) && (plr[p].hyperspac == 0)) {
                ...
                for (a = 0; a < slots; a++) {
                    if (plr[p].activeslot == a) {
                        jcscalespritem((c +=
                                       ...
                                       bulletbox[plr[p].slots[a]].w,
                                       bulletbox[plr[p].slots[a]].h,
                                       (bulletbox[plr[p].slots[a]].w << 1) -
                                           ((bulletbox[plr[p].slots[a]].w *
                                             ((sint[(cnt << 5) & (SCT - 1)] +
                                               FIXS) /
                                              2)) >>
                                            (FIXP + 1)),
                                       (bulletbox[plr[p].slots[a]].h << 1) -
                                           ((bulletbox[plr[p].slots[a]].h *
                                             ((sint[(cnt << 5) & (SCT - 1)] +
                                               FIXS) /
                                              2)) >>
